...
export default function AdminUserinfoModifyCom(){
    ...
    const onClickDuplicationEmail=(e)=>{
        ...
        if( value==='' ){
            ...
            axios({
                url: 'https://sieun.co.kr/innisfree/innisfree_email_duplication.php',
                method: 'POST',
                data: formData
            })
            .then(( res )=>{
    ...
    const onSubmitForm=(e)=>{
        ...
        if(state.pw===''){
            ...
            axios({
                url:'https://sieun.co.kr/innisfree/innisfree_admin_userinfo_modify.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{               
    ...
    const onClickModalClose=(e)=>{
     ...
     const onClickDelete=(e)=>{
        ...
        axios({
            url:'https://sieun.co.kr/innisfree/innisfree_admin_userinfo_delete.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{               
